...
### [35] [Effect of classical noises on the coherent population trapping based on the Green's function approach to the multiplicative stochastic processes](https://arxiv.org/abs/2607.23630)
...
### [36] [Optimal Dynamic Cooling of Multiple Qubits](https://arxiv.org/abs/2607.23641)
...
### [37] [Neural Network Learning of One-Bit Protocols for Qubit Measurement Simulation](https://arxiv.org/abs/2607.23645)
...
### [38] [Mitigation of Measurement-Induced State Transitions via a Fast-Load and Fast-Clear Readout](https://arxiv.org/abs/2607.23681)
...
### [39] [Qutrit-Based Neural Quantum Kernels for Classification Tasks](https://arxiv.org/abs/2607.23683)
...
### [40] [Fixed points in de Finetti hierarchies](https://arxiv.org/abs/2607.23689)
...
### [41] [Can PCE solve the factorisation problem via optimisation?](https://arxiv.org/abs/2607.23727)
...
### [42] [The Physics of Unresolved Uncertainty: Quantum Mechanics as a Theory of Potentiality](https://arxiv.org/abs/2607.23745)
*Lionel Martellini*
...
### [43] [Quantum Separability in Polynomial Time](https://arxiv.org/abs/2607.23773)
*Giulio Malavolta*
...
### [44] [Environment-assisted squeezing in a coherently driven non-Hermitian degenerate parametric oscillator](https://arxiv.org/abs/2607.23816)
...
### [45] [Unified Framework for Bidirectional and Cyclic Teleportation under Noise](https://arxiv.org/abs/2607.23820)
...
### [46] [A Slice-Rank Drift Bound for Random Quantum \(k\)-SAT](https://arxiv.org/abs/2607.23847)
...
### [47] [Entanglement transitions and multifractality in monitored free-fermions with random long-range hopping](https://arxiv.org/abs/2607.23871)
...
### [48] [Strategies for quantum-enabled Bitcoin miners](https://arxiv.org/abs/2607.23952)
...
### [49] [Dynamical Quantum Phase Transitions in a Pseudo-Hermitian Hamiltonian: The Imbalanced-Pairing Kitaev Model](https://arxiv.org/abs/2607.23956)
...
### [50] [Scalable Photon-Mediated Two-Qubit Gates with Spectrally Noisy Quantum Emitters](https://arxiv.org/abs/2607.23959)
...
### [51] [Non-Hermitian-enhanced quantum sensing in an optical interferometer](https://arxiv.org/abs/2607.23978)
...
### [52] [Scaling a CUDA-Q GQE + QSCI pipeline to 40 qubits for EUV photoresist chemistry](https://arxiv.org/abs/2607.23988)
...
### [53] [DeComp2: Description Complexity aware Decomposition](https://arxiv.org/abs/2607.23990)
*Aritra Sarkar*
...
### [54] [Recoverable Quantum Computation: An Information-Centric Paradigm for Quantum Computing with Errors](https://arxiv.org/abs/2607.23996)
*Shengwang Du*
...
### [55] [Scalable Quantum Machine Learning: Trainability, Expressivity and Efficiency](https://arxiv.org/abs/2607.24014)
*Iordanis Kerenidis*
...
### [56] [Pound-Drever-Hall Feedforward for Trapped-Ion Optical Qubits](https://arxiv.org/abs/2607.24050)
...
### [57] [Variational Quantum Conditional Boltzmann Machines for Time-Series Forecasting: Architectures, Symmetric Hyperparameter Evaluation, and a Nonlinear Benchmark](https://arxiv.org/abs/2607.24065)
...
### [58] [Non-classical photon statistics in frequency-modulated double quantum dot cavity systems](https://arxiv.org/abs/2607.24067)
...
### [59] [Simultaneous estimation of relative phase and coherence in astronomical interferometry](https://arxiv.org/abs/2607.24105)
...
### [60] [High-order quantum correlations in nonlinear waveguide quantum electrodynamics](https://arxiv.org/abs/2607.24106)
...
### [61] [Quantum key distribution over a 2 km free-space channel with a high secure key rate](https://arxiv.org/abs/2607.24118)
...
### [62] [Tree Tensor Network Reservoir Computing: Hierarchical Ensemble with Invariant Phase Boundaries](https://arxiv.org/abs/2607.24127)
...
### [63] [Local Universality and Structural Certificates for Minimal Fixed-Depth Two-Qutrit Gate Decomposition](https://arxiv.org/abs/2607.24129)
...
### [64] [DC Conductance of X-shaped Majorana Interferometer reveals Non-Abelian Anyon Statistics](https://arxiv.org/abs/2607.24171)
...
### [65] [Parallelizable Exact Synthesis of Quantum Circuits via Semi-Tensor Product](https://arxiv.org/abs/2607.24195)
...
### [66] [MPStab: an hybrid stabilizers tensor-network quantum circuit simulator](https://arxiv.org/abs/2607.24258)
...
### [67] [Systematic Experiment Tracking in Quantum Software: A Case Study of Reservoir Computing with Error Mitigation](https://arxiv.org/abs/2607.24264)
...
### [68] [Coherence as a resource for $N$-box and quantum pigeonhole paradoxes](https://arxiv.org/abs/2607.24282)
...
### [69] [Quantum-Level Crosstalk Characterization of a 16x16 MEMS Optical Switch for Dynamic Quantum Communications](https://arxiv.org/abs/2607.24299)
...
### [70] [On the two-copy distillability of Werner states and a new partial trace inequality](https://arxiv.org/abs/2607.24309)
...
### [71] [Fast Generation of Metrologically Relevant Fock State Mixtures](https://arxiv.org/abs/2607.24318)
...
### [72] [Electron Shuttle Waiting Times for Electric Field Sensing](https://arxiv.org/abs/2607.24350)
...
### [73] [Multivariate Time Series Forecasting with Adaptive Non-Local Observables](https://arxiv.org/abs/2607.24399)
...
### [74] [A Bogoliubov-ratio framework for quantum-information diagnostics of time-dependent two-mode Boson Hamiltonian](https://arxiv.org/abs/2607.24404)
...
### [104] [Generalized Bloch-like ground states in distinct electron-site configurations derived from the same quasiperiodic structure](https://arxiv.org/abs/2607.23180)
...
### [105] [Local micromechanics in a mean-field model of glasses reveal key properties of its non-equilibrium RSB phase](https://arxiv.org/abs/2607.23603)
...
### [106] [Nanoscale linear response of strongly disordered stable solids](https://arxiv.org/abs/2607.23768)
...
### [107] [Coupling of Cation and Anion Dynamics in Solid Electrolytes Revealed by Virtual Isotopic Substitution Molecular Dynamics](https://arxiv.org/abs/2607.24133)
...
### [108] [A Grand-Canonical Solution to a Class of Random Optimization Problems](https://arxiv.org/abs/2607.24455)
...
### [109] [Learning limit cycles via Hebbian synaptic plasticity](https://arxiv.org/abs/2607.24478)
