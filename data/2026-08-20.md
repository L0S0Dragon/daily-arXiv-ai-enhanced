...
### [2] [Qkabrine: A Joint Architecture, Encoding, and Hyperparameter Search Framework for Quantum Machine Learning](https://arxiv.org/abs/2608.18152)
*Eric Jagwara*
...
### [3] [Fixed-order postselected CHSH reference acquisition for parity-constrained spatial-mode qubits on a commercial cloud photonic processor](https://arxiv.org/abs/2608.18153)
...
### [4] [How Quantum Is the Advantage? A Fair, Calibration- and Noise-Aware Benchmark and Attribution Audit of Quantum Machine Learning for Network Intrusion Detection](https://arxiv.org/abs/2608.18155)
...
### [5] [Observable Scaling Hierarchies in Multiphoton Dissipative Quantum Sensing](https://arxiv.org/abs/2608.18157)
*Shahram Panahiyan*
...
### [7] [Symmetric $N \to M$ telecloning and remote quantum state inference](https://arxiv.org/abs/2608.18223)
...
### [8] [Pseudocontexts forced by finite context hypergraphs](https://arxiv.org/abs/2608.18273)
...
### [9] [Generalizing Pauli Checks for Qudit-based Quantum Error Detection and Mitigation](https://arxiv.org/abs/2608.18332)
...
### [10] [Quantum-geometric bounds on Casimir repulsion](https://arxiv.org/abs/2608.18347)
*Adolfo G. Grushin*
...
### [11] [Variational Quantum Algorithms for Hyperelasticity: Incorporating Nonlinear Constitutive Behavior](https://arxiv.org/abs/2608.18363)
...
### [12] [Entropic Rigidity in Quantum Memories: How Geometry and Algebra Control the Onset of Degeneracy Corrections](https://arxiv.org/abs/2608.18420)
*Yixin Zhao,Fei Yan*
...
### [13] [Multiqubit orthogonal product bases](https://arxiv.org/abs/2608.18421)
*Yvkai Zhao,Lin Chen*
...
### [14] [Asymptotic Entanglement Hiding under Stabilizer Restrictions](https://arxiv.org/abs/2608.18440)
...
### [15] [Multicast quantum network coding as optimal symmetric universal cloning over a quantum network](https://arxiv.org/abs/2608.18471)
...
### [16] [Unified Strong-Field Dynamics Simulations from Atoms to Heterostructures](https://arxiv.org/abs/2608.18472)
...
### [17] [Sampling isometric tensor network states with monitored quantum circuits](https://arxiv.org/abs/2608.18511)
...
### [18] [Integer Linear Programming Decoder for Abelian and Non-Abelian Topological Codes](https://arxiv.org/abs/2608.18512)
...
### [19] [Good Stabilizer Codes from Shallow Clifford Circuits with Random Matchings](https://arxiv.org/abs/2608.18536)
...
### [20] [Direct fidelity estimation through joint fiducial grouping](https://arxiv.org/abs/2608.18548)
...
### [21] [Know Your Qubits, Know Your Users: Personas for Quantum Software](https://arxiv.org/abs/2608.18598)
...
### [22] [Inverse Feshbach's problem: Solvability and solutions](https://arxiv.org/abs/2608.18600)
*Miloslav Znojil*
...
### [23] [Exact Matching-Polynomial Solution of the Periodic Baxter-Fendley $Z_N$ Clock Chain](https://arxiv.org/abs/2608.18633)
...
### [24] [Branching (Almost) Everywhere And All at Once](https://arxiv.org/abs/2608.18644)
*Alyssa Ney*
...
### [25] [(Almost) quadruply optimal unitary designs in 1D](https://arxiv.org/abs/2608.18650)
...
### [26] [Quantum-Logic Tsetlin Machines: Interpretable Quantum Machine Learning with Commuting Projector Clauses](https://arxiv.org/abs/2608.18659)
*Krishna Bhatia*
...
### [27] [Experimental zero-added-loss multiplexing Bell-pair source for long-haul quantum networks](https://arxiv.org/abs/2608.18666)
...
### [28] [An ultracompact dilution refrigerator for fast quantum device characterization](https://arxiv.org/abs/2608.18699)
...
### [29] [Robustness of spin state superpositions for noisy quantum metrology](https://arxiv.org/abs/2608.18757)
...
### [30] [Interior skin focusing and directional mirror transfer in a graded non-Hermitian Krawtchouk network](https://arxiv.org/abs/2608.18800)
*Y. S. Liu,X. Z. Zhang*
...
### [31] [Quantum Mixedness Testing with Pauli Measurements](https://arxiv.org/abs/2608.18839)
...
### [32] [Copy-Protection with Correlated Challenges: Point Functions and More via Decisional Coset Monogamy](https://arxiv.org/abs/2608.18841)
...
### [33] [Secure Medical Data Transmission Using Quantum Key Distribution and Post-Quantum Cryptography in Real-World Fiber Networks](https://arxiv.org/abs/2608.18869)
...
### [34] [The exact price of local realism in CHSH experiments: a measurement-dependence-detection trade-off surface, a moiré phase-locking mechanism that saturates it, and an unmeasured fringe in the fourfold coincidence sum](https://arxiv.org/abs/2608.18886)
*Aaron Alai*
...
### [35] [Quantum Tensor Network Learning with DMRG](https://arxiv.org/abs/2608.18901)
...
### [36] [Real Classical Shadows with Noise](https://arxiv.org/abs/2608.18935)
...
### [37] [Quantum-Enhanced Atomic Sensor via Spin Nonequilibrium Criticality](https://arxiv.org/abs/2608.18941)
...
### [38] [AlphaClifford: Efficient Clifford Synthesis and Transpilation with Model-based RL](https://arxiv.org/abs/2608.18946)
...
### [39] [An ultra-bright, highly-scalable, squeezed light source for hybrid quantum photonics](https://arxiv.org/abs/2608.18950)
...
### [40] [Subsystem Symmetries and Fracton Models in Quantum Error Correction](https://arxiv.org/abs/2608.18961)
*Giovanni Canossa*
...
### [41] [Deviation from linear reduced dynamics always occurs for each non-factorisable system-environment unitary evolution](https://arxiv.org/abs/2608.18977)
*Iman Sargolzahi*
...
### [42] [RushHour: A Dynamically Reconfigurable Lattice-Surgery Architecture](https://arxiv.org/abs/2608.18985)
...
### [43] [Interface Capacity and Architectural Replenishment Determine Entanglement-Generation Speed in Quantum Networks](https://arxiv.org/abs/2608.19020)
*Shi-Ju Ran*
...
### [44] [Bernstein-Vazirani Networks: Quantum Machine Learning by Interference](https://arxiv.org/abs/2608.19043)
...
### [45] [Distinct Modes of Quantum Information Transfer in Power-Law Long-Range Spin Networks](https://arxiv.org/abs/2608.19057)
...
### [46] [Non-Local Search-to-Decision Reduction over F2](https://arxiv.org/abs/2608.19091)
*Prabhanjan Ananth*
...
### [47] [Realizing Logical Diagonal Gates via Transversal Physical $Z$-Rotations in CSS Codes](https://arxiv.org/abs/2608.19094)
...
### [48] [Quantum circuit optimization using deep reinforcement learning: Applications across multiple gate sets](https://arxiv.org/abs/2608.19103)
...
### [49] [Connectivity--Interference Competition in Coherent Transport on Percolated Hierarchical Small-World Networks](https://arxiv.org/abs/2608.19130)
...
### [50] [Entanglement battery and entanglement catalyst in local state discrimination problems](https://arxiv.org/abs/2608.19139)
...
### [51] [Quantum Speedups Require Structure or Depth](https://arxiv.org/abs/2608.19158)
...
### [52] [State--Generator Geometry of Open Quantum Systems: Compatibility and Covariant Transport](https://arxiv.org/abs/2608.19175)
